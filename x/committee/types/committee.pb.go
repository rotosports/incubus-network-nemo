...
// source: nemo/committee/v1beta1/committee.proto
...
type BaseCommittee struct {
	...
	TallyOption      TallyOption   `protobuf:"varint,7,opt,name=tally_option,json=tallyOption,proto3,enum=nemo.committee.v1beta1.TallyOption" json:"tally_option,omitempty"`
}
...
func init() {
	proto.RegisterEnum("nemo.committee.v1beta1.TallyOption", TallyOption_name, TallyOption_value)
	proto.RegisterType((*BaseCommittee)(nil), "nemo.committee.v1beta1.BaseCommittee")
	proto.RegisterType((*MemberCommittee)(nil), "nemo.committee.v1beta1.MemberCommittee")
	proto.RegisterType((*TokenCommittee)(nil), "nemo.committee.v1beta1.TokenCommittee")
}

func init() {
	proto.RegisterFile("nemo/committee/v1beta1/committee.proto", fileDescriptor_f8b8f3da2af937bb)
}
