...
// source: nemo/committee/v1beta1/permissions.proto
...
func init() {
	proto.RegisterType((*GodPermission)(nil), "nemo.committee.v1beta1.GodPermission")
	proto.RegisterType((*SoftwareUpgradePermission)(nil), "nemo.committee.v1beta1.SoftwareUpgradePermission")
	proto.RegisterType((*TextPermission)(nil), "nemo.committee.v1beta1.TextPermission")
	proto.RegisterType((*CommunityCDPRepayDebtPermission)(nil), "nemo.committee.v1beta1.CommunityCDPRepayDebtPermission")
	proto.RegisterType((*CommunityCDPWithdrawCollateralPermission)(nil), "nemo.committee.v1beta1.CommunityCDPWithdrawCollateralPermission")
	proto.RegisterType((*CommunityPoolLendWithdrawPermission)(nil), "nemo.committee.v1beta1.CommunityPoolLendWithdrawPermission")
	proto.RegisterType((*ParamsChangePermission)(nil), "nemo.committee.v1beta1.ParamsChangePermission")
	proto.RegisterType((*AllowedParamsChange)(nil), "nemo.committee.v1beta1.AllowedParamsChange")
	proto.RegisterType((*SubparamRequirement)(nil), "nemo.committee.v1beta1.SubparamRequirement")
}

func init() {
	proto.RegisterFile("nemo/committee/v1beta1/permissions.proto", fileDescriptor_bdfaf7be16465ae4)
}
