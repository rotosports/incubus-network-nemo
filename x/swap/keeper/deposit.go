...
//
// For example, if we have a pool with 100e6 unemo and 400e6 usdx.  The unemo price is 4 usdx and the
// usdx price is 0.25 unemo.  If a depositor adds liquidity of 4e6 unemo and 14e6 usdx, a nemo price of
// 3.50 usdx and a usdx price of 0.29 unemo.  This is a -12.5% slippage is the unemo price, and a 14.3%
