	...
	testCases := []liqTest{
		{
			...
			args{
				...
				initialModuleCoins:         sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(100*NEMO_CF))),
				initialBorrowerCoins:       sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(100*NEMO_CF))),
				initialKeeperCoins:         sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(100*NEMO_CF))),
				depositCoins:               sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(10*NEMO_CF))),
				borrowCoins:                sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(8*NEMO_CF))),
				liquidateAfter:             oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(sdk.NewInt64Coin("unemo", 100004118)),
				expectedTotalBorrowedCoins: nil,
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(100500020))),
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(98000001))), // initial - deposit + borrow + liquidation leftovers
				expectedAuctions: []auctiontypes.Auction{
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              1,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("unemo", 9500390),
							Bidder:          sdk.AccAddress(nil),
							Bid:             sdk.NewInt64Coin("unemo", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
							MaxEndTime:      endTime,
						},
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("unemo", 8004766),
		...
		},
		{
			...
			args{
				...
				borrowCoins:                sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(8*NEMO_CF))),
				liquidateAfter:             oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(sdk.NewInt64Coin("unemo", 100_004_117)),
				expectedTotalBorrowedCoins: sdk.NewCoins(sdk.NewInt64Coin("unemo", 1)),
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(100*NEMO_CF))),
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(98*NEMO_CF))), // initial - deposit + borrow + liquidation leftovers
				expectedAuctions: []auctiontypes.Auction{
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              1,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("unemo", 10000411),
							Bidder:          sdk.AccAddress(nil),
							Bid:             sdk.NewInt64Coin("unemo", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
						...
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("unemo", 8004765),
						LotReturns:        lotReturns,
					},
				},
			},
		...
		},
		{
			...
			args{
				...
				liquidateAfter:             oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(sdk.NewInt64Coin("unemo", 100_004_117)),
				expectedTotalBorrowedCoins: sdk.NewCoins(sdk.NewInt64Coin("unemo", 8_004_766)),
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(110_000_411))),
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(98*NEMO_CF))), // initial - deposit + borrow + liquidation leftovers
		...
		},
		{
			...
			args{
				...
				keeper:               keeper,
				keeperRewardPercent:  sdk.MustNewDecFromStr("0.05"),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(1000*NEMO_CF)), sdk.NewCoin("usdc", sdkmath.NewInt(1000*NEMO_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(1000*BNB_CF)), sdk.NewCoin("btc", sdkmath.NewInt(1000*BTCB_CF))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(100*NEMO_CF))),
				initialKeeperCoins:   sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(100*NEMO_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(50*NEMO_CF))),                                                                                                                                                 // $100 * 0.8 = $80 borrowable
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("usdc", sdkmath.NewInt(20*NEMO_CF)), sdk.NewCoin("unemo", sdkmath.NewInt(10*NEMO_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(2*BNB_CF)), sdk.NewCoin("btc", sdkmath.NewInt(0.2*BTCB_CF))), // $20+$20+$20 = $80 borrowed
				liquidateAfter:       oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(
					sdk.NewInt64Coin("unemo", 1000000710),
					sdk.NewInt64Coin("usdc", 1000003120),
					sdk.NewInt64Coin("bnb", 100000003123),
					sdk.NewInt64Coin("btc", 100000000031),
				),
				expectedTotalBorrowedCoins: nil,
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(102500001))),
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("usdc", sdkmath.NewInt(20*NEMO_CF)), sdk.NewCoin("unemo", sdkmath.NewInt(60000002)), sdk.NewCoin("bnb", sdkmath.NewInt(2*BNB_CF)), sdk.NewCoin("btc", sdkmath.NewInt(0.2*BTCB_CF))), // initial - deposit + borrow + liquidation leftovers
				expectedAuctions: []auctiontypes.Auction{
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              1,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("unemo", 11874430),
							Bidder:          sdk.AccAddress(nil),
					...
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              2,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("unemo", 11874254),
							Bidder:          sdk.AccAddress(nil),
					...
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              3,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("unemo", 11875163),
							Bidder:          sdk.AccAddress(nil),
							Bid:             sdk.NewInt64Coin("unemo", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
						...
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("unemo", 10000782),
						LotReturns:        lotReturns,
					},
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              4,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("unemo", 11876185),
							Bidder:          sdk.AccAddress(nil),
		...
		},
		{
			...
			args{
				...
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(100*NEMO_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(100*BNB_CF)), sdk.NewCoin("btc", sdkmath.NewInt(100*BTCB_CF))),
				initialKeeperCoins:   sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(100*NEMO_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(50*NEMO_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(10*BNB_CF)), sdk.NewCoin("btc", sdkmath.NewInt(1*BTCB_CF))), // $100 + $100 + $100 = $300 * 0.8 = $240 borrowable                                                                                                                                       // $100 * 0.8 = $80 borrowable
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(120*NEMO_CF))),                                                                                              // $240 borrowed
				liquidateAfter:       oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(
					sdk.NewInt64Coin("unemo", 1000101456),
				),
				expectedTotalBorrowedCoins: nil,
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(102500253)), sdk.NewCoin("bnb", sdkmath.NewInt(0.5*BNB_CF)), sdk.NewCoin("btc", sdkmath.NewInt(0.05*BTCB_CF))), // 5% of each seized coin + initial balances
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(170.000001*NEMO_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(90*BNB_CF)), sdk.NewCoin("btc", sdkmath.NewInt(99*BTCB_CF))),
				expectedAuctions: []auctiontypes.Auction{
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              1,
						...
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("unemo", 40036023),
						LotReturns:        lotReturns,
					},
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
					...
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              3,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("unemo", 47504818),
							Bidder:          sdk.AccAddress(nil),
							Bid:             sdk.NewInt64Coin("unemo", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
						...
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("unemo", 40040087),
						LotReturns:        lotReturns,
					},
				},
			},
		...
		},
		{
			...
			args{
				...
				keeper:               keeper,
				keeperRewardPercent:  sdk.MustNewDecFromStr("0.05"),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(1000*NEMO_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(1000*BNB_CF)), sdk.NewCoin("btc", sdkmath.NewInt(1000*BTCB_CF))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(100*NEMO_CF)), sdk.NewCoin("usdc", sdkmath.NewInt(100*NEMO_CF)), sdk.NewCoin("usdt", sdkmath.NewInt(100*NEMO_CF)), sdk.NewCoin("usdx", sdkmath.NewInt(100*NEMO_CF))),
				initialKeeperCoins:   sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(100*NEMO_CF))),
				...
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(35*NEMO_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(10*BNB_CF)), sdk.NewCoin("btc", sdkmath.NewInt(1*BTCB_CF))),       // $270 borrowed
				liquidateAfter:       oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(
					sdk.NewInt64Coin("bnb", 100000078047),
					sdk.NewInt64Coin("btc", 100000000780),
					sdk.NewInt64Coin("unemo", 1000009550),
					sdk.NewInt64Coin("usdx", 1),
				),
				expectedTotalBorrowedCoins: nil,
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(100*NEMO_CF)), sdk.NewCoin("usdc", sdkmath.NewInt(5*NEMO_CF)), sdk.NewCoin("usdt", sdkmath.NewInt(5*NEMO_CF)), sdk.NewCoin("usdx", sdkmath.NewInt(5*NEMO_CF))), // 5% of each seized coin + initial balances
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(135*NEMO_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(10*BNB_CF)), sdk.NewCoin("btc", sdkmath.NewInt(1*BTCB_CF)), sdk.NewCoin("usdx", sdkmath.NewInt(0.000001*NEMO_CF))),
				expectedAuctions: []auctiontypes.Auction{
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              1,
					...
					&auctiontypes.CollateralAuction{
						...
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("unemo", 35010052), // $70.02
						LotReturns:        lotReturns,
					},
				},
			},
		...
		},
		{
			...
			args{
				...
				initialBorrowerCoins:       sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(100*NEMO_CF))),
				initialKeeperCoins:         sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(100*NEMO_CF))),
				depositCoins:               sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(20*NEMO_CF))), // Deposit 20 NEMO
				borrowCoins:                sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(5*NEMO_CF))),  // Borrow 5 NEMO
				liquidateAfter:             oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(120001624))),
				expectedTotalBorrowedCoins: sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(5001709))),
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("unemo", sdkmath.NewInt(100.5*NEMO_CF))),
