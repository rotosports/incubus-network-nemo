...
func TestKvCLIKeysAddRecover(t *testing.T) {
	...
	require.Equal(t, "fury1rsjxn2e4dfl3a2qzuzzjvvgjmmate383yma8a2", f.KeyAddress("test-recover").String())
	...
	require.True(t, exitSuccess)
	require.Equal(t, "fury1qcfdf69js922qrdr4yaww3ax7gjml6pdamu466", f.KeyAddress("test-recover-legacy").String())
...
func TestNemoCLIKeysAddRecoverHDPath(t *testing.T) {
	...
	require.Equal(t, "fury1rsjxn2e4dfl3a2qzuzzjvvgjmmate383yma8a2", f.KeyAddress("test-recoverHD1").String())
	...
	require.Equal(t, "fury1qpj6nstqn0n5gzcsaezspuhulje6msjqc4629u", f.KeyAddress("test-recoverH2").String())
	...
	require.Equal(t, "fury1vayfpstgapt7dmv7074kc3ll8xpf0rlzqfgy20", f.KeyAddress("test-recoverH3").String())
	...
	require.Equal(t, "fury1xvsfnksmhr887skcfrm4pe3va54tkmrtzqnkut", f.KeyAddress("test-recoverH4").String())
	...
	require.Equal(t, "fury1v9plmhvyhgxk3th9ydacm7j4z357s3nhm9eawy", f.KeyAddress("test-recoverH5").String())
	...
	require.True(t, exitSuccess)
	require.Equal(t, "fury1rsjxn2e4dfl3a2qzuzzjvvgjmmate383yma8a2", f.KeyAddress("test-recoverH6").String())
	...
	require.True(t, exitSuccess)
	require.Equal(t, "fury1xvsfnksmhr887skcfrm4pe3va54tkmrtzqnkut", f.KeyAddress("test-recoverH7").String())
